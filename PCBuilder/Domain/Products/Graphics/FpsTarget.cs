...
namespace PCBuilder.Domain.Products.Graphics
{
    public class FpsTarget
    {
            ...
            decimal memoryVideoCardGamingPerformanceFactor, string name)
        {
            ...
            this.CpuGamingPerformanceExponent = cpuGamingPerformanceExponent;
            this.MemoryVideoCardGamingPerformanceFactor = memoryVideoCardGamingPerformanceFactor;
            this.Name = name;
        }
        ...
        public virtual bool Equals(FpsTarget other)
        {
            ...
            return this.AverageFps.Equals(other.AverageFps);
        }

        public override bool Equals(object obj)
        {
            return this.Equals(obj as FpsTarget);
        }

        public override int GetHashCode()
        {
            return this.AverageFps.GetHashCode();
        }

        public override string ToString()
        {
            return this.AverageFps.ToString();
        }
    }
}
